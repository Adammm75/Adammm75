...
|--------|-------------|------------|------|
| 🎬 **AlloCiné Spring Boot** | API + couche service + tests | `Java` `Spring Boot` `MySQL` | [🔗 Repo](https://github.com/Adammn75/ALLO_CINE_SPRING_BOOT_L3_INFO) |
| 💰 **Gestion Bourse** | CRUD complet, services, DTO, validation | `Java` `Spring Boot` `JPA` | [🔗 Repo](https://github.com/Adammn75/GESTION_BOURSE_SPRING_BOOT_L3_INFO) |
| 🏦 **Qard API** | Intégration API, services, HttpClient | `PHP` `Symfony` `Docker` | [🔗 Bientôt](https://github.com/Adammn75) |
...
<!-- Badges de contact avec animations -->
<p align="center">
...
<!-- Section technologies dépliable avec animation -->
<details>
<summary><strong>🛠️ Technologies que je maîtrise</strong> (cliquez pour développer) 🔽</summary>
